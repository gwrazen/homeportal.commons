...
- [ ] 1.1 Build przechodzi: `mvn clean install`
- [ ] 1.2 Build niezalezny od locale i encodingu
- [ ] 1.3 Brak ostrzezen o niewersjonowanych pluginach
- [ ] 1.4 Jedna wersja Spring Framework w drzewie zaleznosci
...
- [ ] 2.1 Wszystkie testy przechodza: `mvn clean install`
- [ ] 2.2 Kazda poprawka ma test czerwony bez niej
- [ ] 2.3 Brak `printStackTrace` poza `FullTextRepositoryImpl`
- [ ] 2.4 Test `ClassFieldReader` z polem `null`
- [ ] 2.5 Test `stripInvalidXmlCharacters` zachowuje pierwszy znak
...
- [ ] 5.1 Build przechodzi: `mvn clean install`
- [ ] 5.2 Brak typow Lucene/HS w `FullTextRepository`
- [ ] 5.3 Test: `getPageItems()` dla zera wynikow zwraca pusta liste
- [ ] 5.4 Test: `Page` roznione numerem strony nie sa rowne
- [ ] 5.5 Test: sortowanie malejace emituje jeden order
- [ ] 5.6 Test: `IndexerMonitor` odrzuca drugie pozyskanie locka
- [ ] 5.7 Test integracyjny FTS (H2 + Lucene RAM)
...
- [ ] 6.1 Build przechodzi: `mvn clean install`
- [ ] 6.2 `mvn dependency:analyze` bez `Used undeclared`
- [ ] 6.3 `spring-test` poza compile classpath
- [ ] 6.4 Workflow CI zielony
- [ ] 6.5 `migration-6.0.md` pokrywa kazda zmiane lamiaca z faz 3-5
