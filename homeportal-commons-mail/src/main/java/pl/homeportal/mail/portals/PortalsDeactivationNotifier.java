...
public class PortalsDeactivationNotifier extends GenericNotifier<PortalsDeactivatedDTO>
{
    private static final Logger LOG = Logger.getLogger(PortalsDeactivationNotifier.class.getSimpleName());

    private static final String SUBJECT = "email.portals.deactivated.subject";
    ...
    @Override
    public void notify(PortalsDeactivatedDTO dto)
    {
        try
        {
            VelocityEmail email = new VelocityEmail(EmailType.PORTALS_DEACTIVATION);
